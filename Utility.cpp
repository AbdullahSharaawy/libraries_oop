...

{
    ...
    cout << clsUtil::GenerateWord(clsUtil::SamallLetter, 8) << endl;
    cout << clsUtil::GenerateKey(clsUtil::SamallLetter) << endl;
   ...
   clsUtil::Swap(d1, d2);
    ...
    string Arr4[5];
    clsUtil::FillArrayWithRandomWords(Arr4, 5, clsUtil::SamallLetter, 8);
    cout << "\nArray after fill:\n";
    for (int i = 0; i < 5; i++)
    {
        cout << Arr4[i] << endl;
    ...
    string Arr5[5];
    clsUtil::FillArrayWithRandomKeys(Arr5, 5, clsUtil::SamallLetter);
